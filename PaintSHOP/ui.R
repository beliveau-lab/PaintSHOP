          ...
          sidebarPanel(
            selectInput("probeset", "Choose Probe Set:",
                         c("hg38 newBalance" = "probes/refseq/hg38_refseq_newBalance.tsv",
                           ...
                           "danRer11 newBalance" = "probes/refseq/danRer11_refseq_newBalance.tsv",
                           "TAIR10 newBalance" = "probes/refseq/TAIR10_refseq_newBalance.tsv",
                           "sacCer3 newBalance" = "probes/refseq/sacCer3_refseq_newBalance.tsv",
                           ...
                           "hg38 newBalance (iso)" = "probes/iso/hg38_iso_db.tsv",
                           "hg19 newBalance (iso" = "probes/iso/hg19_iso_db.tsv",
                           "mm10 newBalance (iso)" = "probes/iso/mm10_iso_db.tsv",
                           "dm6 newBalance (iso)" = "probes/iso/dm6_iso_db.tsv",
                           "ce11 newBalance (iso)" = "probes/iso/ce11_iso_db.tsv")),
         ...
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("hg38 newBalance" = "probes/all/hg38_all_newBalance",
                         ...
                         "danRer11 newBalance" = "probes/all/danRer11_all_newBalance",
                         "TAIR10 newBalance" = "probes/all/TAIR10_all_newBalance",
                         "sacCer3 newBalance" = "probes/all/sacCer3_all_newBalance",
