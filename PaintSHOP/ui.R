      ...
      tabPanel("Documentation",
        ...
        bsCollapse(id = "tutorial_collapse", multiple = TRUE,
          ...
          bsCollapsePanel("Appending Sequences",
                          ...
                          tags$br(),
                          tags$br(),
                          tags$b("PaintSHOP Bridge Set:"), " a set of 1065 new bridge sequences ",
          ...
          bsCollapsePanel("Downloading Designs",
                          ...
                          "appended sequences to your probe set. Next, you can choose the type of ",
                          "file you would like to download from the drop-down menu. PaintSHOP ",
                          "provides three different files for download:",
                          tags$br(),
                          tags$br(),
                          tags$b("1. Order File"),
                          tags$br(),
