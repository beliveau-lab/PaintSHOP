        ...
        sidebarLayout(
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("hg38 newBalance" = "all/hg38_all_newBalance",
                         "hg19 newBalance" = "all/hg19_all_newBalance",
                         "mm10 newBalance" = "all/mm10_all_newBalance",
                         "mm9 newBalance" = "all/mm9_all_newBalance",
                         "dm6 newBalance" = "all/dm6_all_newBalance",
                         "ce11 newBalance" = "all/ce11_all_newBalance",
                         "OligoMiner hg38 balance" = "all/hg38b_all",
                         "OligoMiner hg19 balance" = "all/hg19b_all",
           ...
           radioButtons("coord_manual_or_file", "Input type:",
                        c("Manual" = TRUE, "File" = FALSE),
                        selected = TRUE),
           actionButton("coord_submit", label = tags$h1("Submit"),
                        icon("paper-plane"), width = "100%"),
           tags$br(),
           tags$br(),
