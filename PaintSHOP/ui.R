        ...
        sidebarLayout(
          sidebarPanel(
            selectInput("probeset", "Choose Probe Set:", c(
              ...
              "mm39 newBalance" = "v1.2/probes/refseq/mm39_refseq_newBalance.tsv",
              ...
              "rheMac10 newBalance" = "v1.2/probes/refseq/rheMac10_refseq_newBalance.tsv",
              "xenTro10 newBalance" = "v1.2/probes/refseq/xenTro10_refseq_newBalance.tsv",
              "Nfu_20140520 newBalance" = "v1.2/probes/refseq/Nfu_20140520_refseq_newBalance.tsv",
              "AaegL5.0 newBalance" = "v1.2/probes/refseq/AaegL5.0_refseq_newBalance.tsv",
              "susScr11 newBalance" = "v1.2/probes/refseq/susScr11_refseq_newBalance.tsv",
              "ASM694v2 newBalance" = "v1.2/probes/refseq/ASM694v2_refseq_newBalance.tsv",
              "sScyCan1.1 newBalance" = "v1.2/probes/refseq/sScyCan1.1_refseq_newBalance.tsv",
              ...
              "mm39 newBalance (isoform-flattened)" = "v1.2/probes/iso/mm39_iso_newBalance.tsv",
              ...
              "rheMac10 newBalance (isoform-flattened)" = "v1.2/probes/iso/rheMac10_iso_newBalance.tsv",
              "xenTro10 newBalance (isoform-flattened)" = "v1.2/probes/iso/xenTro10_iso_newBalance.tsv",
              "Nfu_20140520 newBalance (isoform-flattened)" = "v1.2/probes/iso/Nfu_20140520_iso_newBalance.tsv",
              "AaegL5.0 newBalance (isoform-flattened)" = "v1.2/probes/iso/AaegL5.0_iso_newBalance.tsv",
              "susScr11 newBalance (isoform-flattened)" = "v1.2/probes/iso/susScr11_iso_newBalance.tsv",
              "ASM694v2 newBalance (isoform-flattened)" = "v1.2/probes/iso/ASM694v2_iso_newBalance.tsv",
              "sScyCan1.1 newBalance (isoform-flattened)" = "v1.2/probes/iso/sScyCan1.1_iso_newBalance.tsv",
         ...
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("hg38 newBalance" = "v1.2/probes/all/hg38_all_newBalance",
                         ...
                         "mm39 newBalance" = "v1.2/probes/all/mm39_all_newBalance",
                         ...
                         "rheMac10 newBalance" = "v1.2/probes/all/rheMac10_all_newBalance",
                         "xenTro10 newBalance" = "v1.2/probes/all/xenTro10_all_newBalance",
                         "Nfu_20140520 newBalance" = "v1.2/probes/all/Nfu_20140520_all_newBalance",
                         "AaegL5.0 newBalance" = "v1.2/probes/all/AaegL5.0_all_newBalance",
                         "susScr11 newBalance" = "v1.2/probes/all/susScr11_all_newBalance",
                         "ASM694v2 newBalance" = "v1.2/probes/all/ASM694v2_all_newBalance",
                         "sScyCan1.1 newBalance" = "v1.2/probes/all/sScyCan1.1_all_newBalance",
