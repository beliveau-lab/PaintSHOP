      ...
      tabPanel("RNA Probe Design",
        sidebarLayout(
          sidebarPanel(
            ...
            tags$hr(),
            splitLayout(tags$h3("Balance Set (optional)"),
            ...
            shinyBS::bsPopover(id = "rna_balanced_popover",
                               ...
                               content = c("For more information on this feature, ", 
                                           "see the Balancing a Probe Set section in the documentation."),
                               placement = "bottom",
                               trigger = "click"),
      ...
      tabPanel("Documentation",
        ...
        bsCollapse(id = "tutorial_collapse", multiple = TRUE,
          bsCollapsePanel("RNA Probe Design", 
                         ...
                         tags$br(),
                         tags$b("gene_id:"), 
                         " The unique ID generated from chromosome id and gene name e.g. chr7|ACTB. This value is used to group annotations by gene.",
                         tags$br(),
                         tags$b("NOTE:"), 
                         " An additional '*' column is present in downloaded RNA probe sets. This column contains the transcript_id for isoform-resolved probe sets, and the number of isoforms the probe targets for isoform-flattened probe sets.",
                         tags$hr(),
                         tags$b("Note:"), 
                         ...
                         "for the hg38, hg19, mm10, dm6, and ce11 reference genomes.",
