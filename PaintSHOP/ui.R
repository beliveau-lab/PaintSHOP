        ...
        sidebarLayout(
          sidebarPanel(
            selectInput("probeset", "Choose Probe Set:", c(
              "hg38 newBalance" = "v1.1/probes/refseq/hg38_refseq_newBalance.tsv",
              "hg19 newBalance" = "v1.1/probes/refseq/hg19_refseq_newBalance.tsv",
              "mm10 newBalance" = "v1.1/probes/refseq/mm10_refseq_newBalance.tsv",
              "mm9 newBalance" = "v1.1/probes/refseq/mm9_refseq_newBalance.tsv",
              "dm6 newBalance" = "v1.1/probes/refseq/dm6_refseq_newBalance.tsv",
              "ce11 newBalance" = "v1.1/probes/refseq/ce11_refseq_newBalance.tsv",
              "danRer11 newBalance" = "v1.1/probes/refseq/danRer11_refseq_newBalance.tsv",
              "TAIR10 newBalance" = "v1.1/probes/refseq/TAIR10_refseq_newBalance.tsv",
              "sacCer3 newBalance" = "v1.1/probes/refseq/sacCer3_refseq_newBalance.tsv",
              "rn6 newBalance" = "v1.1/probes/refseq/rn6_refseq_newBalance.tsv",
              "galGal5 newBalance" = "v1.1/probes/refseq/galGal5_refseq_newBalance.tsv",
              "galGal6 newBalance" = "v1.1/probes/refseq/galGal6_refseq_newBalance.tsv",
              "OligoMiner hg38 balance" = "v1.1/probes/refseq/hg38b_refseq_newBalance.tsv",
              "OligoMiner hg19 balance" = "v1.1/probes/refseq/hg19b_refseq_newBalance.tsv",
              "2012 Oligopaints hg19" = "v1.1/probes/refseq/hg19_2012_refseq_newBalance.tsv",
              "iFISH4U 40-mer hg19" = "v1.1/probes/refseq/iFISH4U_refseq_newBalance.tsv",
              "hg38 newBalance (isoform-flattened)" = "v1.1/probes/iso/hg38_iso_newBalance.tsv",
              "hg19 newBalance (isoform-flattened)" = "v1.1/probes/iso/hg19_iso_newBalance.tsv",
              "mm10 newBalance (isoform-flattened)" = "v1.1/probes/iso/mm10_iso_newBalance.tsv",
              "mm9 newBalance (isoform-flattened)" = "v1.1/probes/iso/mm9_iso_newBalance.tsv",
              "dm6 newBalance (isoform-flattened)" = "v1.1/probes/iso/dm6_iso_newBalance.tsv",
              "ce11 newBalance (isoform-flattened)" = "v1.1/probes/iso/ce11_iso_newBalance.tsv",
              "danRer11 newBalance (isoform-flattened)" = "v1.1/probes/iso/danRer11_iso_newBalance.tsv",
              "TAIR10 newBalance (isoform-flattened)" = "v1.1/probes/iso/TAIR10_iso_newBalance.tsv",
              "sacCer3 newBalance (isoform-flattened)" = "v1.1/probes/iso/sacCer3_iso_newBalance.tsv",
              "rn6 newBalance (isoform-flattened)" = "v1.1/probes/iso/rn6_iso_newBalance.tsv",
              "galGal5 newBalance (isoform-flattened)" = "v1.1/probes/iso/galGal5_iso_newBalance.tsv",
              "galGal6 newBalance (isoform-flattened)" = "v1.1/probes/iso/galGal6_iso_newBalance.tsv",
              "OligoMiner hg38 balance (isoform-flattened)" = "v1.1/probes/iso/hg38b_iso_newBalance.tsv",
              "OligoMiner hg19 balance (isoform-flattened)" = "v1.1/probes/iso/hg19b_iso_newBalance.tsv",
              "2012 Oligopaints hg19 (isoform-flattened)" = "v1.1/probes/iso/hg19_2012_iso_newBalance.tsv",
              "iFISH4U 40-mer hg19 (isoform-flattened)" = "v1.1/probes/iso/iFISH4U_iso_newBalance.tsv"
            )),
        ...
        sidebarLayout(
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("hg38 newBalance" = "v1.1/probes/all/hg38_all_newBalance",
                         "hg19 newBalance" = "v1.1/probes/all/hg19_all_newBalance",
                         "mm10 newBalance" = "v1.1/probes/all/mm10_all_newBalance",
                         "mm9 newBalance" = "v1.1/probes/all/mm9_all_newBalance",
                         "dm6 newBalance" = "v1.1/probes/all/dm6_all_newBalance",
                         "ce11 newBalance" = "v1.1/probes/all/ce11_all_newBalance",
                         "danRer11 newBalance" = "v1.1/probes/all/danRer11_all_newBalance",
                         "TAIR10 newBalance" = "v1.1/probes/all/TAIR10_all_newBalance",
                         "sacCer3 newBalance" = "v1.1/probes/all/sacCer3_all_newBalance",
                         "rn6 newBalance" = "v1.1/probes/all/rn6_all_newBalance",
                         "galGal5 newBalance" = "v1.1/probes/all/galGal5_all_newBalance",
                         "galGal6 newBalance" = "v1.1/probes/all/galGal6_all_newBalance",
                         "OligoMiner hg38 balance" = "v1.1/probes/all/hg38b_all",
                         "OligoMiner hg19 balance" = "v1.1/probes/all/hg19b_all",
                         "2012 Oligopaints hg19" = "v1.1/probes/all/hg19_2012_all",
                         "iFISH4U 40-mer hg19" = "v1.1/probes/all/iFISH4U_all")),
      ...
      tabPanel("Documentation",
        ...
        bsCollapse(id = "tutorial_collapse", multiple = TRUE,
          bsCollapsePanel("RNA Probe Design", 
                         ...
                         tags$h3("Probe Sets:"),
                         tags$br(),
                         tags$b("newBalance (RNA):"), "probe sets for the hg38, hg19, mm10, mm9, dm6, ce11, danRer11, TAIR10, and sacCer3 genomes",
                         ...
                         "for the hg38, hg19, mm10, dm6, ce11, danRer11, TAIR10, and sacCer3 reference genomes.",
          ...
          bsCollapsePanel("DNA Probe Design", 
                         ...
                         tags$h3("Probe Sets:"),
                         tags$br(),
                         tags$b("newBalance (DNA):"), "probe sets for the hg38, hg19, mm10, mm9, dm6, ce11, danRer11, TAIR10, and sacCer3 genomes",
                         "with a length window of 30-37 nucleotides and a Tm of window of 42-47 degrees. These parameters ",
                         "were selected to optimize probe coverage and hybridization. ",
                         "For more information on these new probe sets, please refer to the PaintSHOP manuscript.",
                         tags$br(),
