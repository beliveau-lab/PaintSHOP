        ...
        sidebarLayout(
          sidebarPanel(
            selectInput("probeset", "Choose Probe Set:",
                         c("hg38 newBalance" = "refseq/hg38_refseq_newBalance.tsv",
                           "hg19 newBalance" = "refseq/hg19_refseq_newBalance.tsv",
                           "mm10 newBalance" = "refseq/mm10_refseq_newBalance.tsv",
                           "mm9 newBalance" = "refseq/mm9_refseq_newBalance.tsv",
                           "dm6 newBalance" = "refseq/dm6_refseq_newBalance.tsv",
                           "ce11 newBalance" = "refseq/ce11_refseq_newBalance.tsv",
                           "OligoMiner hg38 balance" = "refseq/hg38b_refseq.tsv",
                           "OligoMiner hg19 balance" = "refseq/hg19b_refseq.tsv",
                           "2012 Oligopaints hg19" = "refseq/hg19_2012_refseq.tsv",
                           "iFISH4U 40-mer hg19" = "refseq/iFISH4U_refseq.tsv")),
        ...
        sidebarLayout(
         sidebarPanel(
           ...
           selectInput("probeset_coord", "Choose Probe Set:",
                       c("hg38 newBalance" = "all/hg38_all_newBalance.tsv",
                         "hg19 newBalance" = "all/hg19_all_newBalance.tsv",
                         "mm10 newBalance" = "all/mm10_all_newBalance.tsv",
                         "mm9 newBalance" = "all/mm9_all_newBalance.tsv",
                         "dm6 newBalance" = "all/dm6_all_newBalance.tsv",
                         "ce11 newBalance" = "all/ce11_all_newBalance.tsv",
                         "OligoMiner hg38 balance" = "all/hg38b_all.tsv",
                         "OligoMiner hg19 balance" = "all/hg19b_all.tsv",
                         "2012 Oligopaints hg19" = "all/hg19_2012_all.tsv",
                         "iFISH4U 40-mer hg19" = "all/iFISH4U_all.tsv")),
      ...
      tabPanel("Documentation",
        ...
        bsCollapse(id = "tutorial_collapse", multiple = TRUE,
          bsCollapsePanel("RNA Probe Design", 
                         ...
                         tags$a(href = "http://ifish4u.org/", "iFISH4U"), ".",
                         tags$br(),
                         tags$br(),
          ...
          bsCollapsePanel("Appending Sequences",
                          ...
                          tags$a(href = "http://zhuang.harvard.edu/merfish.html", "MERFISH"),
                          ...
                          tags$a(href = "https://www.nature.com/articles/s41586-019-1035-4", "Mateo et al. 2019"),
                          ...
                          tags$a(href = "https://www.pnas.org/content/116/39/19490", "Xia et al. 2019"),
          ...
          bsCollapsePanel("Resources Available",
                          ...
                          "for download in the ", tags$b("Resources"), " tab. The files are all in zip format. ",
