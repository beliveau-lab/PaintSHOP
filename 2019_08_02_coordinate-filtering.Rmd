...
After looking at the documentation, that actually isn't the function or package that I want. Here is what I want:
```{r}
library(fuzzyjoin)

intersect_df <- fuzzyjoin::genome_join(probes, coord_df,
...
Awesome. Now I want to reorder the columns.
```{r}
...
I don't need to reorder anymore.
